...
interface IJoinFormUIProps {
    ...
    inputs: { id: string, password: string, passwordCheck: string }
}
        ...
        <>
            <JS.Wrapper>
                ...
                <form onSubmit={props.onSubmitJoinForm}>
                    <JS.InputBox id="id" type="text" placeholder="이메일을 입력해주세요." onChange={props.onChangeInputs} value={props.inputs.id} />
                    {props.idSpaceErr && <JS.ErrBox>{props.idSpaceErr}</JS.ErrBox>}
                    {props.idEmTypeErr && <JS.ErrBox>{props.idEmTypeErr}</JS.ErrBox>}
                    <JS.InputBox id="password" type="password" placeholder="비밀번호를 입력해주세요." onChange={props.onChangeInputs} value={props.inputs.password} />
                    {props.nonSpecErr && <JS.ErrBox>{props.nonSpecErr}</JS.ErrBox>}
                    <JS.InputBox id="passwordCheck" type="password" placeholder="비밀번호를 다시 입력해주세요." onChange={props.onChangeInputs} value={props.inputs.passwordCheck} />
